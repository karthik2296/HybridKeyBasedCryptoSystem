...
<td class="auto-style1" rowspan="5">
    <asp:Image ID="Image1" runat="server" Height="132px" ImageUrl="~/images/demo/members-icon.png" Width="161px" />
    </td>
...
<asp:Label ID="lbluser" runat="server" Text="Owner Id" ForeColor="#0066FF" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Medium"></asp:Label>
</td>
<td>
...
onclick="btnsubmit_Click" />
    &nbsp;</td>
<td align="left" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnsubmit0" runat="server" Text="Regsiter"
