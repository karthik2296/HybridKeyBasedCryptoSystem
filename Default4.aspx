...
<asp:Label ID="lbluser" runat="server" Text="File Id" ForeColor="Black"></asp:Label>
</td>
...
<asp:Label ID="lblpwd" runat="server" Text="Date" ForeColor="Black"></asp:Label>
</td>
<td class="auto-style6">
...
<td class="auto-style14"></td>
<td  class="auto-style5" >
<asp:Label ID="lblcnfmpwd" runat="server" Text="File Descriptions" ForeColor="Black"></asp:Label>
</td>
<td class="auto-style6">
...
<td class="auto-style14"></td>
<td  class="auto-style5" >
<asp:Label ID="Label1" runat="server" Text="File Data" ForeColor="Black"></asp:Label>
</td>
<td class="auto-style6">
...
<td class="auto-style11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Button ID="btnsubmit" runat="server" Text="Upload"
