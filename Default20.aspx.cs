...
public partial class Default17 : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (Label2.Text != null)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("update newuser SET status='" + status + "', SDI1='" + Label2.Text + "' where Uid='" + u + "'", con);
            cmd.ExecuteNonQuery();
            con.Close();
            string message = "Wating for Update SDi";
