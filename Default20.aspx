<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default20.aspx.cs" Inherits="Default17" %>
...
<div class="wrapper col3">
  <div id="container">
    ...
    <Columns>
        <asp:ButtonField Text="Update SDI" CommandName="Select" ItemStyle-Width="150px" />
...
<HeaderStyle BackColor="#009999" Font-Size="Medium" ForeColor="White"></HeaderStyle>
             ...
             <tr>
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Missing SDI" Visible="False" />
                 </td>
             </tr>
         </table>
        </div>
